...
- **Hydraulic Conductivity (m/s) using screen length**  - estimated hydraulic conductivity calculated using the methodology of Bradury and Rothschild (1985), similar to above, except the aquifer thickness is taken as the screen length.
